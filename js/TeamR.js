...
1000	85.7	72.7	80	100	69.2	80	92.3	72.7	75	81.8	66.7	\n\
2000	75	62.5	91.7	66.7	88.9	33.3	66.7	75	81.8	77.8	90	\n\
3000	77.8	60	36.4	87.5	62.5	25	87.5	100	85.7	85.7	66.7	\n\
4000	42.9	66.7	75	57.1	0	0	57.1	50	66.7	66.7	66.7\n\
5000	100	50	66.7	75	0	0	50	66.7	33.3	75	25\n\
6000	33.3	100	100	66.7	0	0	50	100	100	100	0\n\
";
...
var svg = d3.select("#linesf").append("svg")
  ...
  .on('mousemove', function() { // mouse moving over canvas
    ...
    d3.selectAll(".mouse-per-line")
      .attr("transform", function(d, i) {
        ...
        var xRound = x.invert(mouse[0]),
            bisect = d3.bisector(function(d) { return d.Round; }).right;
            idx = bisect(d.values, xRound);
...
var svg = d3.select("#linest").append("svg")
