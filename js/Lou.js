    ...
    datasetTotal = [
        ...
        {label:"Sweet 16", value:58.33},
        {label:"Elite 8", value:33.33},
        {label:"Final 4", value:20.83},
        {label:"Championship Game", value:8.33},
        {label:"Won it all", value:8.33}
    ];
    ...
    datasetOption2 = [
        {label:"Round of 32", value:75.00},
        {label:"Sweet 16", value:58.33},
        {label:"Elite 8", value:16.67},
        {label:"Final 4", value:16.67},
        {label:"Championship Game", value:8.33},
        {label:"Won it all", value:8.33}
    ];
    ...
    function change(dataset) {
        ...
        svg.append("g")
                ...
                .text("% of Louisville Teams Advanced To");
