var myData = "Round	1-N/A-N/A-N/A\n\
Round of 64	0.0\n\
Round of 32	0.0\n\
Sweet 16	0.0\n\
Elite 8	0.0\n\
...
d3.select("input[value=\"total\"]").property("checked", true);
    datasetTotal = [
        {label:"Round of 32", value:0},
        {label:"Sweet 16", value:0},
        {label:"Elite 8", value:0},
        {label:"Final 4", value:0},
        {label:"Championship Game", value:0},
        {label:"Won it all", value:0}
    ];
